...
const large_airports: string = '/geojson/large_airports.geojson';
const medium_airports: string = '/geojson/medium_airports.geojson';
const small_airports: string = '/geojson/small_airports.geojson';
const heliports: string = '/geojson/heliports.geojson';
